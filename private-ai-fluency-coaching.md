...
One client was highly skeptical of AI, but he loved smart home technology. There happened to be an internet-connected air conditioner in the room, so I pointed to it and said, “Let’s write an app that can control it.” We opened OpenAI’s Codex and asked it to scan the home network. It found the air conditioner. We asked what commands the unit supported. It returned a list of things we could control. Then we had Codex write a small app for those controls. Finally, we asked it to turn the AC on, and the air conditioner behind us came to life. My client was completely sold, not because I explained AI to him, but because he experienced himself making something real.

Another client came to me because he wanted me to build a website for him. After hearing what he needed, I told him he could probably build it himself with AI. He was not ready to believe that, so I had him take out his laptop. I walked him through opening an account with Amazon’s cloud service, then helped him tell an AI agent to set up a web server. It installed the database and the framework. Before long, the website was running. We pointed a domain name to it, and he had the site he originally wanted to hire me to build. He went home excited and kept adding more to it.
